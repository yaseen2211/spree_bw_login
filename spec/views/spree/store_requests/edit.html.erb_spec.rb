...
RSpec.describe "spree/store_requests/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit spree_store_request form" do
    render

    assert_select "form[action=?][method=?]", spree_store_request_path(@spree_store_request), "post" do
